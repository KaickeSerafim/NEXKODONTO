...
class Pagamento(models.Model):
    ...
    dentista = models.ForeignKey(USER, on_delete=models.CASCADE, related_name="pagamentos_recebidos")
    valor = models.DecimalField(max_digits=10, decimal_places=2)
    status= models.CharField(max_length=30, choices=StatusPagamento)
    metodo = models.CharField(max_length=30, choices=MetodoPagamento)
